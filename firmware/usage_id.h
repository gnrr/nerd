/*
 * Filename: usage_id.h
 * Last modified: Sat Jun 24 2006 00:55:36 LMT
 */

/* USAGE ID 定義 (HIDﾚﾎﾟｰﾄ用のｷｰｺｰﾄﾞ) */
...
#define USID_PAD_HYPHONE			0x56 /* -                (PAD) */
...
#define USID_NERD_NONE				0xE8 /* without Nerd X (PLAIN) */
#define USID_NERD_CTRL				0xE9 /* Nerd Control    (NERD) */
#define USID_NERD_META				0xEA /* Nerd Meta       (NERD) */
#define USID_NERD_FUNC				0xEB /* Nerd Function   (NERD) */
#define USID_NERD_LOCK				0xEC /* Nerd Lock       (NERD) */
#define USID_INHERIT_PLAIN			0xED /* from PLAIN   (INHERIT) */
#define USID_INHERIT_CTRL			0xEE /* from NCTRL   (INHERIT) */
#define USID_INHERIT_META			0xEF /* from NMETA   (INHERIT) */


/* 一般キーとして扱う Usage ID 範囲 */
#define USID_GENE_START		USID_NONE;
#define USID_GENE_END		0xDF;

/* ﾓﾃﾞｨﾌｧｲﾔｷｰとして扱う Usage ID 範囲 */
#define USID_MOD_START		USID_MOD_CTRL_L
#define USID_MOD_END		USID_MOD_GUI_R

/* Nerdキーとして扱う Usage ID 範囲   */
#define USID_NERD_START		USID_NERD_CTRL
#define USID_NERD_END		USID_NERD_LOCK

/* 継承キーとして扱う Usage ID 範囲   */
#define USID_INHERIT_START	USID_INHERIT_PLAIN
#define USID_INHERIT_END	USID_INHERIT_META
